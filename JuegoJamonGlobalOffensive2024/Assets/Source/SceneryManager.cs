    ...
    private void ManagePanelControlAction(PlayerAction action, SceneElementInformation information)
    {
        switch (action)
        {
            case PlayerAction.Parafernalia:
                _parafernaliaObject.ReceiveInformation(information);
                break;
            case PlayerAction.Battery:
                _batteryObject.ReceiveInformation(information);
                break;
            case PlayerAction.C1MoveLight:
                _lightC1Object.ReceiveInformation(information);
                break;
            case PlayerAction.C2MoveLight:
                _lightC2Object.ReceiveInformation(information);
                break;
        }
    }
}
